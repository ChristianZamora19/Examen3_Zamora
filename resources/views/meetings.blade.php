      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="row">
            ...
            <?php
             $conn= mysqli_connect("ec2-54-157-79-121.compute-1.amazonaws.com","
             uynevyccmjoqwf","5c857ac1c9aa37158135c415ae48a5bc3626a8ba0874984283a804e0fbf3b6d2","ddq3f1advon3tq");
            ?>
